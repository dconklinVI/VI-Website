...
<div class="container">
	...
	<div id="content" class="blog archive">
		...
		<div class="post" id="post-<?php the_ID(); ?>">
			...
			<div class="entrytext">
				<?php if ($tcx_theme_options['blog_featured_images'] == '1' && has_post_thumbnail()) {echo get_the_post_thumbnail($id, 'thumbnail', array('class' => 'attachment-thumbnail alignleft'));} ?>
